...
StationCheck _$StationCheckFromJson(Map<String, dynamic> json) => StationCheck(
      ...
      hls: boolFromInt((json['hls'] as num?)?.toInt()),
      ok: boolFromInt((json['ok'] as num?)?.toInt()),
      timestamp: DateTime.parse(json['timestamp'] as String),
      urlCache: json['urlcache'] as String,
      metainfoOverridesDatabase:
          boolFromInt((json['metainfo_overrides_database'] as num?)?.toInt()),
      timingMilliseconds: (json['timing_ms'] as num).toInt(),
      sslError: boolFromInt((json['ssl_error'] as num?)?.toInt()),
      public: boolFromInt((json['public'] as num?)?.toInt()),
